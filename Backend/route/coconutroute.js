...
const uploadDir = "./uploads";  // Create upload directory
if(!fs.existsSync(uploadDir)){
    fs.mkdirSync(uploadDir);
};

// set up for filr filtering
...
// List's users get the coconut items
